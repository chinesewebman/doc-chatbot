...
class Chatbot:
    ...
    def conversational_chat(self, query):
        ...
        #else:
        #    chain = ConversationalRetrievalChain.from_llm(llm=llm,
        #        retriever=retriever, condense_question_prompt=self.CONDENSE_QUESTION_PROMPT_WITH_KEYWORDS, verbose=True, return_source_documents=True, max_tokens_limit=4096, combine_docs_chain_kwargs={'prompt': self.QA_PROMPT_WITH_KEYWORDS})         
